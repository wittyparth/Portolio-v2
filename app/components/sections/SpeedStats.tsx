...
export default function SpeedStatsPage() {
    return (
        <div className={`${embedded ? '' : 'bg-[#0d1117] min-h-screen'} font-display text-white flex flex-col items-center justify-center p-4 md:p-8 selection:bg-[#2b6cee]/30`}>
