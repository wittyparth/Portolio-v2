...
export default function ProjectsPage({ embedded = false }: { embedded?: boolean }) {
    ...
    return (
        <PageLayout embedded={embedded} className={embedded ? "" : "bg-[#111318]"}>
            <div className="overflow-x-hidden flex flex-col min-h-screen">
                {/* Navbar - only when not embedded */}
                {!embedded && (
                    <nav className="sticky top-0 z-50 border-b border-[#282e39] bg-[#111318]/90 backdrop-blur-md">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="flex items-center justify-between h-16">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <h2 className="text-white text-xl font-bold tracking-tight">Partha.dev</h2>
                                </div>
                                {/* Desktop Menu */}
                                    ...
                                    {navLinks.map(link => (
                                        <a
                                            ...
                                            className={`text-sm font-medium transition-colors ${link.isActive
                                                ? 'text-[#2b6cee] border-b-2 border-[#2b6cee] py-1'
                                ...
                                <div className="hidden md:flex">
                                    <a
                                        href="/contact"
                                        className="flex items-center gap-2 bg-[#2b6cee] hover:bg-blue-600 transition-all text-white px-5 py-2 rounded-lg text-sm font-bold tracking-wide shadow-[0_0_15px_rgba(43,108,238,0.3)]"
                                    >
                ...
                {/* Terminal Footer - only when not embedded */}
                {!embedded && (
                    <footer className="w-full bg-[#0d0f14] border-t border-[#282e39] py-12 mt-auto">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div className="font-mono text-sm space-y-4">
                                    <p className="text-[#586070]">$ echo "Let's build something together"</p>
                                    <p className="text-white">&gt; Sending email to <span className="text-[#2b6cee]">hello@partha.dev</span>...</p>
                                    <p className="text-green-500">&gt; Ready to connect_</p>
                                    <div className="flex gap-4 pt-4">
                                        <a className="text-[#9da6b9] hover:text-white transition-colors" href="#">Twitter</a>
                                        <a className="text-[#9da6b9] hover:text-white transition-colors" href="#">GitHub</a>
                                        <a className="text-[#9da6b9] hover:text-white transition-colors" href="#">LinkedIn</a>
                                        <a className="text-[#9da6b9] hover:text-white transition-colors" href="#">Discord</a>
                                    </div>
                                </div>
                                <div className="flex flex-col items-start md:items-end justify-between">
                                    <div className="text-[#586070] text-sm text-right">
                                        <p>© 2024 Partha Saradhi. All rights reserved.</p>
                                        <p className="mt-2 text-xs">Designed with <span className="text-red-500">♥</span> and too much caffeine.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
